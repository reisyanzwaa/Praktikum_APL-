...
void tambahPengunjung() {
    ...
    cout << "\nIsi Biodata Diri dan Peminjaman:\n";
    cout << "Nama: ";
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    getline(cin, pengunjungBaru.nama);
    cout << "NIM: ";
    cin >> pengunjungBaru.nim;
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    cout << "Umur: ";
    cin >> pengunjungBaru.umur;
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
    cout << "Alamat: ";
    ...
    cin >> pengunjungBaru.lama_peminjaman;
...
void hapusPengunjung() {
    int nim;
    cout << "Masukkan NIM pengunjung yang ingin dihapus: ";
    cin >> nim;
...
void editPengunjung() {
    int nim;
    cout << "Masukkan NIM pengunjung yang ingin diedit: ";
    cin >> nim;
    bool pengunjungDitemukan = false;
        ...
        switch (pilihanUtama) {
            case 1: {
                ...
                while (true) {
                    ...
                    if (pilihanAdmin == 5) {
                        isAdmin = false; // Keluar dari mode admin saat memilih opsi 5
                        break;
                    }
                }
                break;
